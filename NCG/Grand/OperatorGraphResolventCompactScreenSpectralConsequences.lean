...
/-!
# Spectral consequences of asymptotic operator-graph screens

The eventual graph-screen condition from the manuscript now feeds directly into the complete
compact self-adjoint spectral package: compact limit, literal norm convergence, an automatically
selected Riesz circle, exact limiting eigenspace, stable multiplicity, norm-convergent spectral
projections, and convergence of every finite projected source Gram matrix.
-/
...
/-- Monotone eventual compact-screen tightness for canonical graph resolvents implies the full
automatic-circle spectral approximation package. -/
theorem operatorGraphResolvent_fullSpectralConsequences_of_uniformGraphScreenTight
    {ι : Type x}
