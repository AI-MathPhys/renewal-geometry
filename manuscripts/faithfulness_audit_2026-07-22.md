...
Does every tracked record correspond **exactly** to the statement as written in
the manuscript text — no undisclosed narrowing, no extra assumptions, no
tautological anchors? This file audits all **333 records**:
