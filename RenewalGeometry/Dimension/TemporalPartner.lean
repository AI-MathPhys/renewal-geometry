...
(`RenewalGeometry.even_finrank_of_isAlt_nondegenerate`, `RenewalGeometry.no_two_plus_one`,
`RenewalGeometry.three_le_of_odd_nondegenerate`) this supplies the symplectic
