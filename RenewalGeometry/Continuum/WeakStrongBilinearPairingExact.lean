...
namespace RenewalGeometry.WeakStrongBilinearPairing
...
theorem tendsto_of_strong_of_bounded_weak
  ...
  have hsecond : Tendsto (fun i => B xlim (y i)) l (𝓝 (B xlim ylim)) :=
    RenewalGeometry.tendsto_apply_of_tendsto_toWeakSpace hy (B xlim)
...
end RenewalGeometry.WeakStrongBilinearPairing
