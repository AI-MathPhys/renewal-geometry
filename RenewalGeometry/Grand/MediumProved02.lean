...
`RenewalGeometry.LowIsland.islandProj`), `K_j = QᴴW_jQ`, `Ω = I + ∑_j W_j`.  The
...
open MeasureTheory
open RenewalGeometry.SourceCoercivityInfluence RenewalGeometry.GeometricThresholdBank RenewalGeometry.PsdBlockSchur
open RenewalGeometry.MetricTransport RenewalGeometry.SourceAction RenewalGeometry.LowIslandRM
