...
namespace RenewalGeometry.PalatiniDeterminantVolume
...
theorem determinantVolume_tendsto_of_coframe_interpolation
  ...
  exact RenewalGeometry.StrongInterpolationConvergence.tendsto_of_norm_interpolation
...
theorem determinant_firstVariation_at_invertible
  ...
  refine (RenewalGeometry.hasDerivAt_det hentries).congr_deriv ?_
...
end RenewalGeometry.PalatiniDeterminantVolume
