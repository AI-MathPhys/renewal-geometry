...
namespace RenewalGeometry.FiniteSpectralCommutatorGramCarrierExact
...
theorem commutatorGram_sourceMinimal
  ...
  dsimp only
  have h := RenewalGeometry.source_kernel_realization_minimal_unique
...
end RenewalGeometry.FiniteSpectralCommutatorGramCarrierExact
