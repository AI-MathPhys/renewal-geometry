...
theorem eigenspace_compressed_jointCommutatorResolventFamily
  ...
  rw [J.eigenspace_compressedOperator_eq_map
    (RenewalGeometry.jointCommutatorResolventFamily c b) cutoff (((b : ℝ) : ℂ)⁻¹)
  ...
  exact (operatorGraphKernel_eq_resolventEigenspace
    ...
    b hb (RenewalGeometry.jointCommutatorResolventFamily c b cutoff)
    (RenewalGeometry.jointCommutatorResolventFamily_resolventEquation c b hb cutoff)).symm
