...
namespace RenewalGeometry.PalatiniWeakStrongLimit
...
theorem curvature_pairing_tendsto_of_coframe_interpolation
  ...
  have hcoframe : Tendsto coframe l (𝓝 coframeLimit) :=
    RenewalGeometry.StrongInterpolationConvergence.tendsto_of_norm_interpolation
  ...
  have hbivector : Tendsto (fun i => wedge (coframe i) (coframe i)) l
    ...
    RenewalGeometry.StrongInterpolationConvergence.tendsto_diagonal_bilinear
      wedge coframe coframeLimit hcoframe
  exact RenewalGeometry.WeakStrongBilinearPairing.tendsto_of_strong_of_bounded_weak
...
end RenewalGeometry.PalatiniWeakStrongLimit
