...
open RenewalGeometry.SourceCoercivityInfluence RenewalGeometry.GeometricThresholdBank RenewalGeometry.PsdBlockSchur
...
screening range (`RenewalGeometry.ChargeFlux`), with the zero-residual classification
...
open RenewalGeometry.RenormCongruence
...
open RenewalGeometry.SMSTReflectionPositivity
