...
theorem complementCompression_compressedOperator
    ...
    RenewalGeometry.SpectralGap.complementCompression (J.compressedOperator T n)
        (J.compressedOperator P n) =
      J.compressedOperator
        (fun k ↦ RenewalGeometry.SpectralGap.complementCompression (T k) (P k)) n := by
  ext x
  simp [RenewalGeometry.SpectralGap.complementCompression, compressedOperator,
...
theorem norm_complementCompression_compressedOperator
    ...
    ‖RenewalGeometry.SpectralGap.complementCompression (J.compressedOperator T n)
        (J.compressedOperator P n)‖ =
      ‖RenewalGeometry.SpectralGap.complementCompression (T n) (P n)‖ := by
