...
* `RenewalGeometry.pressure_strictAnti`, `RenewalGeometry.pressure_continuous`,
  `RenewalGeometry.pressure_tendsto_zero` — analytic behaviour of the pressure;
* `RenewalGeometry.pressure_eq_one_existsUnique` —
