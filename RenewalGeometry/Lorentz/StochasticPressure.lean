...
configurations. -/
noncomputable def heatBathMatrix (D : RenewalGeometry.CommonOrigin.IsingData ι)
...
theorem heatBathMatrix_nonneg (D : RenewalGeometry.CommonOrigin.IsingData ι)
    (ν : ι → ℝ) (hν : ∀ i, 0 ≤ ν i) :
...
theorem heatBathMatrix_rowSum (D : RenewalGeometry.CommonOrigin.IsingData ι)
    (ν : ι → ℝ) (hν1 : ∑ i, ν i = 1) :
...
theorem heatBathMatrix_diag_pos (D : RenewalGeometry.CommonOrigin.IsingData ι)
...
theorem heatBathMatrix_diagWitness
    (D : RenewalGeometry.CommonOrigin.IsingData ι) (ν : ι → ℝ)
...
theorem heatBathMatrix_update_pos (D : RenewalGeometry.CommonOrigin.IsingData ι)
