...
namespace RenewalGeometry.FiniteWeightedGraphHodgeDirac
...
theorem norm_sq_dirac_commutator
  ...
  change ‖RenewalGeometry.FiniteSpectralizationBlockNormExact.offDiagonal
      (lipschitzBlock mass conductance f)‖ ^ 2 = _
  rw [RenewalGeometry.FiniteSpectralizationBlockNormExact.norm_offDiagonal]
...
theorem dirac_commutator_norm_eq_zero_iff_constant
  ...
  rw [RenewalGeometry.FiniteSpectralizationBlockNormExact.norm_offDiagonal, norm_eq_zero]
...
end RenewalGeometry.FiniteWeightedGraphHodgeDirac
